...
class MyButton2 extends StatefulWidget {
  const MyButton2(this.setStatePage,{super.key, required this.icon, required this.bName});
  final Icon icon;
  final String bName;
  ...
  bool getBool() {
    return _MyButton2State().isSelected;
  }
...
class _MyButton2State extends State<MyButton2> {
  ...
  void initState() {
    icons = widget.icon;
    name = widget.bName;
    isSelected = accountDetailController.selectedPersonality.contains(name);
    super.initState();
  }
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: () {
            ...
            accountDetailController.togglePersonality(name);
          },
          child: Container(
