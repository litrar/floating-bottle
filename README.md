...
```
cd existing_repo
git remote add origin https://gitlab.com/SpeedReach/floating-bottle.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/SpeedReach/floating-bottle/-/settings/integrations)
...
=======
# Floating Bottle - Connect and Bottle it!
